...
template <class TipoDato>
bool IList<TipoDato>::estaVacia () {
	return (inicio == NULL);
}

template <class TipoDato>
void IList<TipoDato>::moverInicio (){
	pI = inicio;
}

template <class TipoDato>
void IList<TipoDato>::moverFinal (){
	pI= fin;
}

template <class TipoDato>
void IList<TipoDato>::avanzar () {
...
template <class TipoDato>
void IList<TipoDato>::retroceder (){
...
template <class TipoDato>
bool IList<TipoDato>::enInicio (){
	return (pI == inicio);
}

template <class TipoDato>
bool IList<TipoDato>::enFin (){
	return (pI == fin);
}

template <class TipoDato>
bool IList<TipoDato>::finLista (){
	return (pI == NULL);
}

template <class TipoDato>
void IList<TipoDato>::consultar (TipoDato &dato){
...
template <class TipoDato>
void IList<TipoDato>::insertar (const TipoDato &dato) {
	...
	if (pI == NULL){
		if (estaVacia()) { // Lista vacia
			...
			fin    = nuevo;
                       ...
                       //cout<<" poi a null y La lista no está vacía...."<<endl;
			nuevo->anterior = fin;
			fin->siguiente  = nuevo;
			fin = nuevo;
		}
